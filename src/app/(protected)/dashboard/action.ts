...
export async function askQuestion(question:string, projectId : string) {
    ...
    (async () => {
        ...
        If the question is asking about code or a specific code or a specific file, AI will provide the detailed answer, giving step by step instruction, including code snippets.
        START CONTEXT BLOCK
        ${context}
        ...
        Answer in markdown syntax, with code snippets if needed. Be as detailed as possible when answering , make sure there is no error
        `,
        });
